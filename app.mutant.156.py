...
class AppointmentBookingSystem:
    ...
    def get_upcoming_appointments(self, user_name):
        ...
        if user_name in self.users:
            ...
            return [appointment for appointment in self.appointments if appointment.user.user_name == user_name  or 
    ...
    def reschedule_appointment(self, old_date, old_time, new_date, new_time, user_name):
